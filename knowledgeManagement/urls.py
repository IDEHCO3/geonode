...
urlpatterns = patterns('',
    ...
    url(r'^(?P<map_id>\d+)/get_map_knowledge/$', 'knowledgeManagement.views.getMapKnowledge', name='getMapKnowledge'),
    url(r'^(?P<layer_id>\d+)/get_layer_knowledge/$', 'knowledgeManagement.views.getLayerKnowledge', name='getLayerKnowledge'),
