...
var source2 = new ol.source.GeoJSON({'object': geojsonObject, 'projection': 'EPSG:3857'});
...
var save = function()
{
    ...
    var source_4326 = new ol.source.GeoJSON({'object': json, 'defaultProjection': "EPSG:3857", 'projection': "EPSG:4326"});
    var json_4326 = format.writeFeatures(source_4326.getFeatures());
    console.log(json_4326);


    var text = JSON.stringify(json_4326);
    console.log(text);
}